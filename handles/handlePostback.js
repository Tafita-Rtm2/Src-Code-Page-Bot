...
async function handlePostback(event, pageAccessToken) {
  ...
  const welcomeText = userName
    ...
    : `👋 Bienvenue  sur Bot Traduction Rtm ! 🤖 Je suis ravi de vous aider à traduire votre texte, votre phrase ou votre mot dans la langue de votre choix 🔍Pour commencer, n'hésitez pas à saisir le texte, la phrase ou le mot que vous souhaitez que je traduise et je ferai de mon mieux pour vous aider 📝ecrire, et commençons à traduire ! 💬";
